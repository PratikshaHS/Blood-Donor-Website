					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<a href="donor-list-map.php" style="font-size: 11px;" class="btn btn-info ml-auto">View
									In
									Map</a>
														...
														<td>
															<?php if ($result->status == 1) { ?>
																<a href="donor-list.php?hidden=<?php echo htmlentities($result->id); ?>"
																	...
																	class="btn btn-primary"> Make it Hidden</a>
															<?php } else { ?>
																...
																<a href="donor-list.php?public=<?php echo htmlentities($result->id); ?>"
																	...
																	class="btn btn-primary"> Make it Public</a>
